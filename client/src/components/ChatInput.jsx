...
const ChatInput = ({handleSendMsg}) => {
    ...
    const handleEmojiClick = (emojiClickData, event) => {
    ...
    .button-container {
        ...
        .emoji {
            ...
            .EmojiPickerReact{
                ...
                border-color: #9a86f3;
                .EmojiPickerReact.epr-emoji-scroll-wrapper::-webkit-scrollbar {
                    background-color: #080420;
                    width: 5px;
                    &-thumb {
                ...
                .EmojiPickerReact.epr-emoji-categories {
                    button {
                        filter: contrast(0);
                    }
                }
                .EmojiPickerReact.epr-emoji-search {
